...
class _ListPageState extends State<ListPage> {
  ...
  Widget buildSection(String title, int itemCount, bool isBucketList) {
    final backgroundColor = isBucketList ? Colors.white : const Color(0xff2d2d2d);
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {},
                  constraints: const BoxConstraints.tightFor(width: 5, height: 20),
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                buildSection(dayTitle, 5, isBucketListSelected),
